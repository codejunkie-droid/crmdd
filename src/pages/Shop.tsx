      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <Link to="/shop" className="px-6 py-2 bg-ink text-white rounded-full font-bold text-sm shadow-lg shadow-ink/20 hover:scale-105 transition-transform duration-300">
              All
            </Link>
            {CATEGORIES.map((c, i) => (
              <motion.div
              ...
              >
                <Link 
                  ...
                  className="px-6 py-2 bg-white border border-gray-200 rounded-full font-bold text-sm hover:border-brand hover:bg-brand/10 transition-all duration-300 shadow-sm hover:shadow-md block"
                >
                  {c}
                </Link>
              </motion.div>
